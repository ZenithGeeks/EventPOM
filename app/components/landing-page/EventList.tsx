                        ...
                        <div key={event.id} className="w-full m-4 bg-white overflow-hidden">
                            ...
                            <div className="p-2">
                                <Link href={`/buyTicketsPage/${event.id}`}>
                                    <h3 className="duration-300 text-md font-semibold hover:text-red-500">{event.title}</h3>
                                </Link>
                                <p>{new Date(event.startTime).toLocaleDateString()} - {new Date(event.endTime).toLocaleDateString()}</p>
